...
class ClassVideoSessionController extends Controller
{
    /**
     ...
     *
     * @param \App\ClassVideoSession $classVideoSession
     * @return \Illuminate\Http\Response
     */
    public function getLiveVideoClass(Request $request)
    {
        ...
        $class_video_session = ClassVideoSession::where('instructorcourseid', '=', request('instructorcourseid'))->first();
        $eligible = false;
        ...
        if (!$class_video_session) {
            return response()->json(array(
                'eligible' => $eligible,
                'intructorcourse' => $instructorcourse,
                'enrolment' => $enrolment,
                'class_video_session' => $class_video_session
            ));
        }
    ...
    public function classSessionRefreshData(Request $request)
    {
        ...
        $session_changed = $class_video_session->sessionid != request('sessionid');
        ...
        $drawing_coordinates = DB::table('drawing_coordinates')->where('classsessionid', $class_video_session->sessionid)->get();

        /*$process = new Process(['ffprobe', '-v', 'quiet', '-print_format', 'json', '-show_streams', $class_video_session->streamurl]);
        $process->run();
...
//            'streaming' => false
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ClassVideoSession $classVideoSession)
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, ClassVideoSession $classVideoSession)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(ClassVideoSession $classVideoSession)
    {
        //
    }
}
